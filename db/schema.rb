...
ActiveRecord::Schema.define(version: 2021_01_30_064718) do
  ...
  create_table "shipping_adds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_shipping_adds_on_purchase_record_id"
  end
  ...
  add_foreign_key "shipping_adds", "purchase_records"
end

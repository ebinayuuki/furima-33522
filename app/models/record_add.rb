class RecordAdd
  ...
  def save
    ...
    ShippingAdd.create(postal_code: postal_code, prefecture_id: prefecture_id, municipality: municipality,
                       house_number: house_number, building: building, phone: phone, purchase_record_id: purchase_record.id)
  end
end
